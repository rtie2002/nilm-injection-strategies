...
from S2S_Model import get_model, weights_loader
import os
import numpy as np
...
if args.transfer:
    ...
    param_file = args.trained_model_dir+'/cnn_s2s_' + appliance_name + '_transf_' + args.cnn + '_pointnet_model'
else:
    print('arg.transfer'.format(args.transfer))
    param_file = args.trained_model_dir+'/cnn_s2s_' + args.appliance_name + '_pointnet_model'
