...
from NILM_Models import weights_loader
import numpy as np
...
def get_arguments():
    ...
    parser.add_argument('--datadir',
                        type=str,
                        default='dataset_preprocess/created_data/REDD/',  # -------------------------------
...
model = GRU_model(args.appliance_name,
                  inp,
...
if args.transfer:
    ...
    param_file = args.trained_model_dir + '/GRU_' + appliance_name + '_transf_' + args.cnn + '_pointnet_model'
else:
    print('arg.transfer'.format(args.transfer))
    param_file = args.trained_model_dir + '/GRU_' + args.appliance_name + '_pointnet_model'
