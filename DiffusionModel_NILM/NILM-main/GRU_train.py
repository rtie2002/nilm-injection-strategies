...
if not args.transfer_model and args.transfer_cnn:
    save_path = args.save_dir + '/GRU_' + appliance_name + '_transf_' + args.cnn + '_pointnet_model'
else:
    save_path = args.save_dir + '/GRU_' + appliance_name + '_pointnet_model'
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('GRU_loss-{}_mid-point.png'.format(appliance_name))
plt.show()
